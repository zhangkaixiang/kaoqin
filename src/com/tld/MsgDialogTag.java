...
public class MsgDialogTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException{
    	...
    	sb.append(".msgicon{float:left;background-image:url("+basepath+"/images/msgDialog/msgtitle_icon.jpg); background-repeat:no-repeat; height:20px;width:20px;}\n");
    	sb.append(".msgtilte{float:left; text-align:left;background-image:url("+basepath+"/images/msgDialog/msgtitle_back.jpg); background-repeat:repeat-x;line-height:20px;letter-spacing:2px; height:20px; width:"+titlewidth+"px;}\n");
    	sb.append(".msgclose{float:left;background-image:url("+basepath+"/images/msgDialog/btn_close.jpg); background-repeat:no-repeat; height:20px; width:20px; cursor:pointer;}\n");
