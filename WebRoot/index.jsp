              ...
              <tr>
                ...
                <td width="518" style="background:url(images/login03.jpg)"><table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="242" height="50"><input type="text" name="username" id="textfield" style="width:164px; height:32px; line-height:24px; background:url(images/inputbg.gif) repeat-x; border:solid 1px #d1d1d1; font-size:9pt; font-family:Verdana, Geneva, sans-serif;"></td>
                  </tr>
                  <tr>
                    <td height="50"><img src="images/password.gif" width="28" height="32"></td>
                    <td height="50">密码</td>
                    <td height="50"><input type="password" name="password" id="textfield2" style="width:164px; height:32px; line-height:24px; background:url(images/inputbg.gif) repeat-x; border:solid 1px #d1d1d1; font-size:9pt; "></td>
                  </tr>
                  <tr>
                    <td height="40">&nbsp;</td>
                    <td height="40">&nbsp;</td>
                    <td height="60"><img src="images/login.gif" width="95" height="34"  style="cursor:pointer;" onclick="document.loginForm.submit()" ></td>
                  </tr>
                </table></td>
